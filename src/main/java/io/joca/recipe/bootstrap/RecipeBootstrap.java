package io.joca.recipe.bootstrap;
...
//		avocado.setUom(unitOfMeasureRepository.findByDescription("Unit").get());
//		
//		Ingredient kosher = new Ingredient();
//		kosher.setDescription("Kosher Salt");
//		kosher.setAmount(new BigDecimal(0.5));
//		kosher.setUom(unitOfMeasureRepository.findByDescription("Teaspoon").get());
//		
//		Ingredient lime = new Ingredient();
//		lime.setDescription("fresh lime juice or lemon juice");
//		lime.setAmount(new BigDecimal(2));
//		lime.setUom(unitOfMeasureRepository.findByDescription("Tablespoon").get());
//		
//		Ingredient onion = new Ingredient();
//		onion.setDescription("");
...
//		
//		Optional<Category> am = categoryRepository.findByDescription("American");
//		Optional<Category> me = categoryRepository.findByDescription("Mexican");
//		
//		am.ifPresent(c -> {
//			r1.getCategories().add(am.get());			
//		});
//		
//		me.ifPresent(uom -> {
//			r1.getCategories().add(me.get());			
//		});
//		
//		r1.getIngredients().add(avocado);
//		r1.getIngredients().add(kosher);
//		r1.getIngredients().add(lime);
//		r1.getIngredients().add(onion);
//		
//		avocado.setRecipe(r1);
//		kosher.setRecipe(r1);
//		lime.setRecipe(r1);
//		onion.setRecipe(r1);
//		
